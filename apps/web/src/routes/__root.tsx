...
import { DesktopTaskbarUnreadCoordinator } from "../components/desktop/DesktopTaskbarUnreadCoordinator";
    ...
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        >
          ...
          {primaryEnvironmentAuthenticated && isElectron ? (
            <DesktopTaskbarUnreadCoordinator />
          ) : null}
